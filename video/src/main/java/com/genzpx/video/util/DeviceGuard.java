...
public class DeviceGuard {
    ...
    public static String[] steps() {
        switch (brand()) {
            case BRAND_XIAOMI:
                return new String[]{
                        "Setelan → Aplikasi → Kelola aplikasi → Video",
                        "Buka Hemat baterai, pilih Tanpa batasan",
                        "Kembali, lalu aktifkan Mulai otomatis",
                        "Di layar Aplikasi Terkini, tahan kartu Video lalu tekan ikon gembok"
                };
            case BRAND_OPPO:
            case BRAND_REALME:
                return new String[]{
                        "Setelan → Baterai → Konsumsi daya latar belakang, izinkan Video",
                        "Setelan → Aplikasi → Video → Izin mulai otomatis, aktifkan",
                        "Di layar Aplikasi Terkini, tahan kartu Video lalu tekan ikon gembok"
                };
            case BRAND_VIVO:
                return new String[]{
                        "Setelan → Baterai → Konsumsi daya tinggi latar belakang, izinkan Video",
                        "Setelan → Aplikasi → Akses khusus → Mulai otomatis, aktifkan untuk Video",
                        "Di layar Aplikasi Terkini, tahan kartu Video lalu tekan ikon gembok"
                };
            case BRAND_SAMSUNG:
                return new String[]{
                        "Setelan → Baterai → Batas penggunaan latar belakang",
                        "Buka Aplikasi tidak pernah tidur, tambahkan Video",
                        "Pastikan Video tidak ada di daftar Aplikasi tidur"
                };
            case BRAND_HUAWEI:
                return new String[]{
                        "Setelan → Baterai → Peluncuran aplikasi",
                        "Cari Video, ubah ke Kelola manual",
                        "Aktifkan ketiganya: Luncurkan otomatis, Luncurkan sekunder, Jalan di latar belakang"
                };
            case BRAND_TRANSSION:
                return new String[]{
                        "Buka Phone Master → Penghemat daya",
                        "Masukkan Video ke daftar yang dilindungi",
                        "Setelan → Aplikasi → Video → Baterai, pilih Tanpa batasan"
                };
            case BRAND_ONEPLUS:
                return new String[]{
                        "Setelan → Baterai → Optimasi baterai → Video → Jangan optimalkan",
            ...
            case BRAND_ASUS:
                return new String[]{
                        ...
                        "Masukkan Video ke daftar Boot otomatis",
                        "Setelan → Aplikasi → Video → Baterai, pilih Tanpa batasan"
                };
            default:
                return new String[]{
